...
public interface Constants {
    ...
    String TAG_SIZE = "item_tag_size";

    String FRAME_METAL = "metal";
    String FRAME_WOOD = "wood";
    String FRAME_PAPER = "paper";
    String FRAME_CANVAS = "canvas";

    String REGION_INDIA = "india";
    String REGION_BRITAIN = "britain";
    String REGION_EUROPE = "europe";
    String REGION_OTHER = "other";

    String REGION_TYPE_COUNTRY = "country";
    String REGION_TYPE_CONTINENT = "continent";
}
